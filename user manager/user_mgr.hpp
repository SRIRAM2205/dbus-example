...
class UserMgr : public Ifaces
{
  public:
    ...
    std::string calciDescription() const override;
    std::string calciDescription(std::string value) override;

   uint32_t calculator(uint32_t var1,uint32_t var2,uint32_t n) override;
