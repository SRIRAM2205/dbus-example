...
std::string UserMgr::calciDescription() const{
	return UserMgrIface::calciDescription();
}
std::string UserMgr::calciDescription(std::string value){
	if(value==UserMgrIface::calciDescription())
	{
		return value;
	}
	return UserMgrIface::calciDescription(value);
}
uint32_t UserMgr::calculator(uint32_t var1, uint32_t var2,uint32_t n){
